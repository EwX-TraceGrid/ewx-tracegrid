...
This subdirectory contains the initial base from the open-source KrakenSDR project, licensed under GNU GPL v3.
...
See full license text here: COPYING

All our modifications will remain open and licensed under the same terms.
ewx-tracegrid/prototype_kraken at main · EwX-TraceGrid/ewx-tracegrid
